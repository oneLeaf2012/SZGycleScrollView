...
@interface HPCycleScrollView () <UICollectionViewDataSource, UICollectionViewDelegate>
...
{
    HPCycleScrollView *cycleScrollView = [[self alloc] initWithFrame:frame];
...
- (void)setupMainView
{
    ...
    [mainView registerClass:[HPCollectionViewCell class] forCellWithReuseIdentifier:ID];
...
{
    HPCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:ID forIndexPath:indexPath];
